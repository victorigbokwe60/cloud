...
function Feature() {
    return (
           <div id="feature" className="relative mt-20 border-b borer-neutral-800 min-h-[800px]">
            <div className="text-center">
                <span className="bg-neutral-900 text-orange-500 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase">
                Why Choose Us
                </span>
                <h2 className="text-3xl sm:text-5xl lg:text-6 mt-10 lg:mt-20 tracking-wide">Easily build 
